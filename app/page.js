                    ...
                    <div>
                        <h1 className="flex items-center gap-4 text-4xl md:text-5xl font-extrabold">
                            ...
                            <span className="hidden md:inline text-inherit">
                                {" "}
                                - Fun & Quick Browser Games
                            </span>
                        </h1>
                        <p className="mt-2 text-sky-200/70 max-w-xl">
                            Five compact, polished games designed for quick fun and to test your
                            skills. Save favorites to play later.
                        </p>
                        <div className="mt-4">
                            <Link
                                href="/games"
                                className="px-4 py-2 bg-white/90 text-sky-700 rounded-full font-medium shadow-sm"
                            >
                                Browse Games
                            </Link>
                        </div>
